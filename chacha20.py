...
# # Demonstration with output
# if __name__ == "__main__":
#     print("ChaCha20 Encryption/Decryption Demo")
#     print("-" * 40)
    
#     # Test with simple text
#     plaintext = b"Hello, ChaCha20 encryption!"
    
#     # Generate key using our new function
...
#     # Encrypt
#     encrypted = chacha20_encrypt(plaintext, key, iv)
#     print(f"Encrypted (hex): {encrypted.hex()}")
    
#     # Decrypt using the dedicated decrypt function
...
#         f.write(b"This is a test file with multiple lines.\n" * 1000)  # Create ~33KB file
...
#     file_key, file_salt = encrypt_file(test_file_path, encrypted_file_path)
#     print(f"File encrypted and saved to: {encrypted_file_path}")
#     print(f"Key used (hex): {file_key.hex()}")
    
#     print("\nDecrypting file...")
#     success = decrypt_file(encrypted_file_path, decrypted_file_path, file_key)
#     if success:
#         print(f"File decrypted and saved to: {decrypted_file_path}")
        
#         # Verify files match
#         with open(test_file_path, "rb") as f1, open(decrypted_file_path, "rb") as f2:
...
#     except:
#         print("\nFailed to clean up some test files.")
